...
/* package github.com/nickooan/ntee-db/nteedb-js/capi */
...
extern char* nteedb_put(unsigned int h, char* key, unsigned char* val, int valLen, char* ixJSON, long long int ttlMillis);
extern char* nteedb_incr(unsigned int h, char* key, long long int delta, long long int ttlMillis);
extern char* nteedb_topup(unsigned int h, char* key, long long int amount, long long int max, long long int ttlMillis);
extern char* nteedb_take(unsigned int h, char* key, long long int amount, long long int left, long long int ttlMillis);
